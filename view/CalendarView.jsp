...
<body>
	...
	<table width = "400" cellpadding = "2" cellspacing = "0" border = "0" align = "center">
		...
		<tr>
			<td width="140" align="right"><input type="button" value="◁" onClick="monthDown(this.form)" class="btn btn-default"></td>
			<td width="120" align="center"><select name="year" onchange="selectCheck(this.form)">
			...
			%>
			</select><select name = "month" onchange = "selectCheck(this.form)" class = "col-lg-2 control-label">
			<%
				for(int i = 1;i<=12;i++)
				{
			...
			<td width="140"><input type="button" value="▷" onClick="monthUp(this.form)" class="btn btn-default"></td>
			</tr>
			<tr>
	...
	<table cellpadding = "2" cellspacing = "0" border = "1" align = "center" class = "table table-striped table-hover">
	<tr align="center">
